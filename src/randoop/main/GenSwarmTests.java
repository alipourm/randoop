...
public class GenSwarmTests extends GenInputsAbstract {

  private static final String command = "genswarmtests";

  private static final String pitch = "Generates swarm unit tests for a set of classes.";

  private static final String commandGrammar = "genswarmtests OPTIONS";
  ...
  private static Options options = new Options(
      ...
      SwarmForwardGen.class,
      AbstractGenerator.class);

  public GenSwarmTests() {
...
//     System.setSecurityManager(randoopSecurityManager);
    ...
    explorer = new SwarmForwardGen(model, timelimit * 1000, inputlimit, componentMgr, null, listenerMgr, outputTestFilters);
    /////////////////////////////////////////
